 ...
 */
export const createTable = pgTableCreator((name) => `class_${name}`);
...
export const enrollments = createTable(
  ...
  (enrollment) => ({
    uniqueEnrollment: primaryKey(enrollment.userId, enrollment.classId),
  }),
);
...
export const schedules = createTable(
  ...
  (schedule) => ({
    uniqueScheduleEntry: primaryKey(schedule.userId, schedule.classId),
  }),
);
